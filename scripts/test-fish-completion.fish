...
printf '%s\n' 'wirecmd {' 'git-root #false' 'mcp "alpha" { scope "workspace"; stdio (template)"${wirecmd.global-root}/never-started" }' 'mcp "global alpha" { scope "global"; stdio "never-started" }' 'mcp "space name" { scope "workspace"; stdio "never-started" }' 'mcp "$(touch SHOULD_NOT_EXIST)" { scope "workspace"; stdio "never-started" }' 'mcp "quote\"name" { scope "workspace"; stdio "never-started" }' 'mcp "--help" { scope "workspace"; stdio "never-started" }' 'mcp "-h" { scope "workspace"; stdio "never-started" }' 'mcp "--" { scope "workspace"; stdio "never-started" }' '}' >"$config"
